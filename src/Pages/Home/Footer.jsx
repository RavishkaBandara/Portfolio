  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <p className="footer--content">Made by Gura</p>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/ravishkagurulumulla"
            ...
            <li>
              <a
                href="https://www.instagram.com/ravishkag.99/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/RavishkaBandar3"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ravishka-gurulumulla-6319941bb/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
